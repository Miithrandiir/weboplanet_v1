...
!function(){var e="onfocusin"in document.createElement("input")?"focusin":"focus",t=document.createElement("div");t.appendChild(document.createTextNode("x-")),t.appendChild(document.createTextNode("x")),t.normalize();var n=3==t.firstChild.length;function i(){}function o(){}function r(e,t){var n=t.text.replace(/\r/g,"").length;if(e.compareEndPoints("StartToStart",t)<=0)return 0;if(e.compareEndPoints("StartToEnd",t)>=0)return n;for(var i=0;e.compareEndPoints("StartToStart",t)>0;++i,e.moveStart("character",-1));return i}function a(e,t){var n=t.text.replace(/\r/g,"").length;if(e.compareEndPoints("EndToEnd",t)>=0)return n;if(e.compareEndPoints("EndToStart",t)<=0)return 0;for(var i=0;e.compareEndPoints("EndToStart",t)>0;++i,e.moveEnd("character",-1));return i}function s(){}function l(){}function c(e,t){if(e.firstChild)return e.firstChild;if(e.nextSibling)return e.nextSibling;if(e===t)return null;for(;e.parentNode;){if((e=e.parentNode)==t)return null;if(e.nextSibling)return e.nextSibling}return null}function u(e,t,n,i){if(!(t<=0)){var o=e[n?"startContainer":"endContainer"];for(3==o.nodeType&&(t+=e[n?"startOffset":"endOffset"]);o;){if(3==o.nodeType){var r=o.nodeValue.length;if(t<=r){if(e[n?"setStart":"setEnd"](o,t),t==r){for(var a=c(o,i);a&&3==a.nodeType&&0==a.nodeValue.length;a=c(a,i))e[n?"setStartAfter":"setEndAfter"](a);a&&1==a.nodeType&&"BR"==a.nodeName&&e[n?"setStartAfter":"setEndAfter"](a)}return}e[n?"setStartAfter":"setEndAfter"](o),t-=r}o=c(o,i)}}}bililiteRange=function(t,n){var i;if(n)i=new b;else if(window.getSelection&&t.setSelectionRange)try{t.selectionStart,i=new s}catch(e){i=new b}else i=window.getSelection?new l:document.selection?new o:new b;if(i._el=t,i._doc=t.ownerDocument,i._win="defaultView"in i._doc?i._doc.defaultView:i._doc.parentWindow,i._textProp=function(e){return void 0!==e.value?"value":void 0!==e.text?"text":void 0!==e.textContent?"textContent":"innerText"}(t),i._bounds=[0,i.length()],!("bililiteRangeMouseDown"in i._doc)){var r={_el:i._doc};i._doc.bililiteRangeMouseDown=!1,bililiteRange.fn.listen.call(r,"mousedown",function(){i._doc.bililiteRangeMouseDown=!0}),bililiteRange.fn.listen.call(r,"mouseup",function(){i._doc.bililiteRangeMouseDown=!1})}if(!("bililiteRangeSelection"in t)){function a(e){e&&9==e.which?i._nativeSelect(i._nativeRange(t.bililiteRangeSelection)):t.bililiteRangeSelection=i._nativeSelection()}a(),"onbeforedeactivate"in t?i.listen("beforedeactivate",a):i.listen("mouseup",a).listen("keyup",a),i.listen(e,function(){i._doc.bililiteRangeMouseDown||i._nativeSelect(i._nativeRange(t.bililiteRangeSelection))})}if(!("oninput"in t)){var c=function(){i.dispatch({type:"input"})};i.listen("keyup",c),i.listen("cut",c),i.listen("paste",c),i.listen("drop",c),t.oninput="patched"}return i},i.prototype={length:function(){return this._el[this._textProp].replace(/\r/g,"").length},bounds:function(e){if(bililiteRange.bounds[e])this._bounds=bililiteRange.bounds[e].apply(this);else{if(!e){var t=[Math.max(0,Math.min(this.length(),this._bounds[0])),Math.max(0,Math.min(this.length(),this._bounds[1]))];return t[1]=Math.max(t[0],t[1]),t}this._bounds=e}return this},select:function(){var e=this._el.bililiteRangeSelection=this.bounds();return this._el==document.activeElement&&this._nativeSelect(this._nativeRange(e)),this.dispatch({type:"select"}),this},text:function(e,t){if(arguments.length){var n=this.bounds();this._el;return this.dispatch({type:"beforeinput",data:e,bounds:n}),this._nativeSetText(e,this._nativeRange(n)),"start"==t?this.bounds([n[0],n[0]]):"end"==t?this.bounds([n[0]+e.length,n[0]+e.length]):"all"==t&&this.bounds([n[0],n[0]+e.length]),this.dispatch({type:"input",data:e,bounds:n}),this}return this._nativeGetText(this._nativeRange(this.bounds())).replace(/\r/g,"")},insertEOL:function(){return this._nativeEOL(),this._bounds=[this._bounds[0]+1,this._bounds[0]+1],this},sendkeys:function(e){var t=this;function n(e,t){/^{[^}]*}$/.test(t)&&(t=t.slice(1,-1));for(var n=0;n<t.length;++n){var i=t.charCodeAt(n);e.dispatch({type:"keypress",keyCode:i,which:i,charCode:i})}e.text(t,"end")}return this.data().sendkeysOriginalText=this.text(),this.data().sendkeysBounds=void 0,e.replace(/{[^}]*}|[^{]+|{/g,function(e){(bililiteRange.sendkeys[e]||n)(t,e,n)}),this.bounds(this.data().sendkeysBounds),this.dispatch({type:"sendkeys",which:e}),this},top:function(){return this._nativeTop(this._nativeRange(this.bounds()))},scrollIntoView:function(e){var t=this.top();return(this._el.scrollTop>t||this._el.scrollTop+this._el.clientHeight<t)&&(e?e.call(this._el,t):this._el.scrollTop=t),this},wrap:function(e){return this._nativeWrap(e,this._nativeRange(this.bounds())),this},selection:function(e){return arguments.length?this.bounds("selection").text(e,"end").select():this.bounds("selection").text()},clone:function(){return bililiteRange(this._el).bounds(this.bounds())},all:function(e){return arguments.length?(this.dispatch({type:"beforeinput",data:e}),this._el[this._textProp]=e,this.dispatch({type:"input",data:e}),this):this._el[this._textProp].replace(/\r/g,"")},element:function(){return this._el},dispatch:function(e){e=e||{};var t=document.createEvent?document.createEvent("CustomEvent"):this._doc.createEventObject();for(var n in t.initCustomEvent&&t.initCustomEvent(e.type,!!e.bubbles,!!e.cancelable,e.detail),e)t[n]=e[n];var i=this._el;return setTimeout(function(){try{i.dispatchEvent?i.dispatchEvent(t):i.fireEvent("on"+e.type,document.createEventObject())}catch(r){var n=i["listen"+e.type];if(n)for(var o=0;o<n.length;++o)n[o].call(i,t)}},0),this},listen:function(e,t){var n=this._el;n.addEventListener?n.addEventListener(e,t):(n.attachEvent("on"+e,t),(n["listen"+e]=n["listen"+e]||[]).push(t));return this},dontlisten:function(e,t){var n=this._el;if(n.removeEventListener)n.removeEventListener(e,t);else try{n.detachEvent("on"+e,t)}catch(r){var i=n["listen"+e];if(i)for(var o=0;o<i.length;++o)i[o]===t&&(i[o]=function(){})}return this}},bililiteRange.fn=i.prototype,bililiteRange.extend=function(e){for(fn in e)i.prototype[fn]=e[fn]},bililiteRange.bounds={all:function(){return[0,this.length()]},start:function(){return[0,0]},end:function(){return[this.length(),this.length()]},selection:function(){return this._el==document.activeElement?(this.bounds("all"),this._nativeSelection()):this._el.bililiteRangeSelection}},bililiteRange.sendkeys={"{enter}":function(e){var t="\n".charCodeAt(0);e.dispatch({type:"keypress",keyCode:t,which:t,charCode:t}),e.insertEOL()},"{tab}":function(e,t,n){n(e,"\t")},"{newline}":function(e,t,n){n(e,"\n")},"{backspace}":function(e){var t=e.bounds();t[0]==t[1]&&e.bounds([t[0]-1,t[0]]),e.text("","end")},"{del}":function(e){var t=e.bounds();t[0]==t[1]&&e.bounds([t[0],t[0]+1]),e.text("","end")},"{rightarrow}":function(e){var t=e.bounds();t[0]==t[1]&&++t[1],e.bounds([t[1],t[1]])},"{leftarrow}":function(e){var t=e.bounds();t[0]==t[1]&&--t[0],e.bounds([t[0],t[0]])},"{selectall}":function(e){e.bounds("all")},"{selection}":function(e){for(var t=e.data().sendkeysOriginalText,n=0;n<t.length;++n){var i=t.charCodeAt(n);e.dispatch({type:"keypress",keyCode:i,which:i,charCode:i})}e.text(t,"end")},"{mark}":function(e){e.data().sendkeysBounds=e.bounds()}},bililiteRange.sendkeys["{Enter}"]=bililiteRange.sendkeys["{enter}"],bililiteRange.sendkeys["{Tab}"]=bililiteRange.sendkeys["{tab}"],bililiteRange.sendkeys["{Backspace}"]=bililiteRange.sendkeys["{backspace}"],bililiteRange.sendkeys["{Delete}"]=bililiteRange.sendkeys["{del}"],bililiteRange.sendkeys["{ArrowRight}"]=bililiteRange.sendkeys["{rightarrow}"],bililiteRange.sendkeys["{ArrowLeft}"]=bililiteRange.sendkeys["{leftarrow}"],o.prototype=new i,o.prototype._nativeRange=function(e){var t;return"INPUT"==this._el.tagName?t=this._el.createTextRange():(t=this._doc.body.createTextRange()).moveToElementText(this._el),e&&(e[1]<0&&(e[1]=0),e[0]>this.length()&&(e[0]=this.length()),e[1]<t.text.replace(/\r/g,"").length&&(t.moveEnd("character",-1),t.moveEnd("character",e[1]-t.text.replace(/\r/g,"").length)),e[0]>0&&t.moveStart("character",e[0])),t},o.prototype._nativeSelect=function(e){e.select()},o.prototype._nativeSelection=function(){var e=this._nativeRange(),t=this.length(),n=this._doc.selection.createRange();try{return[r(n,e),a(n,e)]}catch(e){return n.parentElement().sourceIndex<this._el.sourceIndex?[0,0]:[t,t]}},o.prototype._nativeGetText=function(e){return e.text},o.prototype._nativeSetText=function(e,t){t.text=e},o.prototype._nativeEOL=function(){"value"in this._el?this.text("\n"):this._nativeRange(this.bounds()).pasteHTML("\n<br/>")},o.prototype._nativeTop=function(e){var t=this._nativeRange([0,0]);return e.boundingTop-t.boundingTop},o.prototype._nativeWrap=function(e,t){var n=document.createElement("div");n.appendChild(e);var i=n.innerHTML.replace("><",">"+t.htmlText+"<");t.pasteHTML(i)},s.prototype=new i,s.prototype._nativeRange=function(e){return e||[0,this.length()]},s.prototype._nativeSelect=function(e){this._el.setSelectionRange(e[0],e[1])},s.prototype._nativeSelection=function(){return[this._el.selectionStart,this._el.selectionEnd]},s.prototype._nativeGetText=function(e){return this._el.value.substring(e[0],e[1])},s.prototype._nativeSetText=function(e,t){var n=this._el.value;this._el.value=n.substring(0,t[0])+e+n.substring(t[1])},s.prototype._nativeEOL=function(){this.text("\n")},s.prototype._nativeTop=function(e){var t=this._el.cloneNode(!0);t.style.visibility="hidden",t.style.position="absolute",this._el.parentNode.insertBefore(t,this._el),t.style.height="1px",t.value=this._el.value.slice(0,e[0]);var n=t.scrollHeight;return t.value="X",n-=t.scrollHeight,t.parentNode.removeChild(t),n},s.prototype._nativeWrap=function(){throw new Error("Cannot wrap in a text element")},l.prototype=new i,l.prototype._nativeRange=function(e){var t=this._doc.createRange();return t.selectNodeContents(this._el),e&&(u(t,e[0],!0,this._el),t.collapse(!0),u(t,e[1]-e[0],!1,this._el)),t},l.prototype._nativeSelect=function(e){this._win.getSelection().removeAllRanges(),this._win.getSelection().addRange(e)},l.prototype._nativeSelection=function(){var e=this._nativeRange();if(0==this._win.getSelection().rangeCount)return[this.length(),this.length()];var t=this._win.getSelection().getRangeAt(0);return[v(t,e),g(t,e)]},l.prototype._nativeGetText=function(e){return String.prototype.slice.apply(this._el.textContent,this.bounds())},l.prototype._nativeSetText=function(e,t){t.deleteContents(),t.insertNode(this._doc.createTextNode(e)),n&&this._el.normalize()},l.prototype._nativeEOL=function(){var e=this._nativeRange(this.bounds());e.deleteContents();var t=this._doc.createElement("br");t.setAttribute("_moz_dirty",""),e.insertNode(t),e.insertNode(this._doc.createTextNode("\n")),e.collapse(!1)},l.prototype._nativeTop=function(e){if(0==this.length)return 0;if(""==e.toString()){var t=this._doc.createTextNode("X");e.insertNode(t)}var n=this._nativeRange([0,1]),i=e.getBoundingClientRect().top-n.getBoundingClientRect().top;return t&&t.parentNode.removeChild(t),i},l.prototype._nativeWrap=function(e,t){t.surroundContents(e)};var h=0,d=1,p=2,f=3;function v(e,t){return e.compareBoundaryPoints(h,t)<=0?0:e.compareBoundaryPoints(f,t)>=0?t.toString().length:((e=e.cloneRange()).setEnd(t.endContainer,t.endOffset),t.toString().replace(/\r/g,"").length-e.toString().replace(/\r/g,"").length)}function g(e,t){return e.compareBoundaryPoints(p,t)>=0?t.toString().length:e.compareBoundaryPoints(d,t)<=0?0:((e=e.cloneRange()).setStart(t.startContainer,t.startOffset),e.toString().replace(/\r/g,"").length)}function b(){}b.prototype=new i,b.prototype._nativeRange=function(e){return e||[0,this.length()]},b.prototype._nativeSelect=function(e){},b.prototype._nativeSelection=function(){return[0,0]},b.prototype._nativeGetText=function(e){return this._el[this._textProp].substring(e[0],e[1])},b.prototype._nativeSetText=function(e,t){var n=this._el[this._textProp];this._el[this._textProp]=n.substring(0,t[0])+e+n.substring(t[1])},b.prototype._nativeEOL=function(){this.text("\n")},b.prototype._nativeTop=function(){return 0},b.prototype._nativeWrap=function(){throw new Error("Wrapping not implemented")};var y=[];bililiteRange.fn.data=function(){var e=this.element().bililiteRangeData;return null==e&&(e=this.element().bililiteRangeData=y.length,y[e]=new _(this)),y[e]};try{Object.defineProperty({},"foo",{});var _=function(e){Object.defineProperty(this,"values",{value:{}}),Object.defineProperty(this,"sourceRange",{value:e}),Object.defineProperty(this,"toJSON",{value:function(){var e={};for(var t in _.prototype)t in this.values&&(e[t]=this.values[t]);return e}}),Object.defineProperty(this,"all",{get:function(){var e={};for(var t in _.prototype)e[t]=this[t];return e}})};_.prototype={},Object.defineProperty(_.prototype,"values",{value:{}}),Object.defineProperty(_.prototype,"monitored",{value:{}}),bililiteRange.data=function(e,t){t=t||{};var n=Object.getOwnPropertyDescriptor(_.prototype,e)||{};"enumerable"in t&&(n.enumerable=!!t.enumerable),"enumerable"in n||(n.enumerable=!0),"value"in t&&(_.prototype.values[e]=t.value),"monitored"in t&&(_.prototype.monitored[e]=t.monitored),n.configurable=!0,n.get=function(){return e in this.values?this.values[e]:_.prototype.values[e]},n.set=function(t){this.values[e]=t,_.prototype.monitored[e]&&this.sourceRange.dispatch({type:"bililiteRangeData",bubbles:!0,detail:{name:e,value:t}})},Object.defineProperty(_.prototype,e,n)}}catch(e){(_=function(e){this.sourceRange=e}).prototype={},bililiteRange.data=function(e,t){"value"in t&&(_.prototype[e]=t.value)}}}(),Array.prototype.forEach||(Array.prototype.forEach=function(e){"use strict";if(null==this)throw new TypeError;var t=Object(this),n=t.length>>>0;if("function"!=typeof e)throw new TypeError;for(var i=arguments.length>=2?arguments[1]:void 0,o=0;o<n;o++)o in t&&e.call(i,t[o],o,t)}),bililiteRange.fancyText=function(e,t,n){if("textarea"==e.tagName.toLowerCase()){var i=document.createElement("pre");i.setAttribute("contenteditable",!0),[].forEach.call(e.attributes,function(e){i.setAttribute(e.name,e.value)}),i.textContent=e.value,e.parentNode.replaceChild(i,e),e=i}var o=bililiteRange(e);function r(){o.bounds("selection"),/\n$/.test(e.textContent)||(e.textContent+="\n"),t(e),o.select()}return t&&(r(),o.listen("input",function(e,t){return t?function(){var i=this,o=arguments;clearTimeout(n),n=setTimeout(function(){e.apply(i,o)},t)}:e;var n}(r,n))),o.listen("paste",function(e){o.bounds("selection").text(e.clipboardData.getData("text/plain").replace(/\r/g,""),"end").select(),e.preventDefault()}),o.listen("keydown",function(e){13==e.keyCode&&(o.bounds("selection").text("\n","end",o.data().autoindent).select(),e.preventDefault())}),e},Prism.hooks.add("before-insert",function(e){var t=e.element;if(t.hasAttribute("data-linenumber")){var n=parseInt(t.getAttribute("data-linenumber"))||0;t.style.counterReset=getComputedStyle(t).counterReset.replace(/-?\d+/,n-1);var i="<span class=line >",o=e.highlightedCode.replace(/\n<\/span>/g,"</span>\n");e.highlightedCode=i+o.split("\n").join("</span>\n"+i)+"</span>"}});var editor=document.querySelector("pre");editor=bililiteRange.fancyText(editor,Prism.highlightElement);